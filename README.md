...
<!-- Suggested: docs/assets/screenshots/hero-menubar.png -->
...
<!-- Suggested: docs/assets/screenshots/setup-wizard.png -->
<!-- Size: ~600px wide -->
...
<!-- Suggested: docs/assets/screenshots/key-rotation-options.png -->
<!-- Size: ~400px wide -->
...
<!-- Suggested: docs/assets/screenshots/enterprise-sso-landing.png -->
<!-- Size: ~600px wide -->
...
<!-- Suggested: docs/assets/screenshots/multi-account-menubar.png -->
...
<!-- Suggested: docs/assets/screenshots/personal-setup-success.png -->
<!-- Size: ~500px wide -->
...
<!-- Suggested: docs/assets/screenshots/enterprise-cert-success.png -->
<!-- Size: ~600px wide -->
